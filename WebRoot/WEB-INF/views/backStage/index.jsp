...
<div class="leftnav">
  ...
  <ul style="display:block">
	...
	<li><a href="column.html" target="right"><span class="icon-caret-right"></span>视频管理</a></li>
	<li><a href="column.html" target="right"><span class="icon-caret-right"></span>直播管理</a></li>
	<li><a href="column.html" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
  </ul>   
