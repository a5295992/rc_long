  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: base+'/www/upload/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: base+'/www/upload/images/bramus/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
